<%@ Page Title="" Language="C#" MasterPageFile="~/CoOrdinator.master" AutoEventWireup="true" CodeFile="coordinatorchangepw.aspx.cs" Inherits="AdminDefault" %>
              ...
              <td style="height: 33px;font-size:13px; width: 257px;">
                ...
                <tr>
                  <td colspan="3">
                      ...
                      <asp:Button  class="button" ID="btnSubmit" width="111px" runat="server" Text="submit"
                          onclick="btnSubmit_Click" validationgroup="Registration" Height="25px" />
