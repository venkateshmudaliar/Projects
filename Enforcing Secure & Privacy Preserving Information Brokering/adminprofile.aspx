<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="adminprofile.aspx.cs" Inherits="AdminDefault" %>
...
<div style="padding-left:30px;padding-top:20px;padding-bottom:20px;">
         ...
         <asp:Button ID="proview"  class="button"  runat="server" Text="Admin Profile" 
