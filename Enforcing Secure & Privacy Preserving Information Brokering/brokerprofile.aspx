<%@ Page Title="" Language="C#" MasterPageFile="~/Broker.master" AutoEventWireup="true" CodeFile="brokerprofile.aspx.cs" Inherits="AdminDefault" %>
...
<div style="padding-left:30px;padding-top:20px;padding-bottom:20px;">
         ...
         <asp:Button ID="proview"  class="button"  runat="server" Text="Broker Profile" 
