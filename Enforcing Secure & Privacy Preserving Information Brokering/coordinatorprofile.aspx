<%@ Page Title="" Language="C#" MasterPageFile="~/CoOrdinator.master" AutoEventWireup="true" CodeFile="coordinatorprofile.aspx.cs" Inherits="AdminDefault" %>
...
<div style="padding-left:30px;padding-top:20px;padding-bottom:20px;">
         ...
         <asp:Button ID="proview" class="button"  runat="server" Text="Coordinator Profile" 
                 onclick="proview_Click" style="font-size:15px;" Height="29px" />
                 <tr><td></td></tr>
